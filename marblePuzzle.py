...
def marblePuzzle ():
    ...
    if play in ("B, b"):
        ...
        print('''\n"You can only place one marble in each slot, and you have to make \na total of 6 rows of exactly 4 marbles each with these 12 marbles I give you."''')
        time.sleep(6)
        ...
        while not win:
            ...
            for x in com:
                lines += com[x]
            print("\n|||||You have made "+str(lines)+" lines with " +str(12-remains)+" marbles|||||")
            print(grid)
