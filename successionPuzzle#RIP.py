    ...
    #Now you're looking at the Front
            ...
            if deci in ("A","a"):
                ...
                if not lock:
                    ...
                    if Wall[2] == "_":
                        print(ringMove(0, int(query[0])))
                    else:
                        print(ringMove(int(Wall[2]), int(query[0])))
                    Wall[2] = query[0]
                    print("".join(Wall))
                    ...
                    if Wall[8] == "_":
                        print(ringMove(0, int(query[1])))
                    else:
                        print(ringMove(int(Wall[8]), int(query[1])))
                    Wall[8] = query[1]
                    print("".join(Wall))
                    ...
                    if Wall[14] == "_":
                        print(ringMove(0, int(query[2])))
                    else:
                        print(ringMove(int(Wall[14]), int(query[2])))
                    Wall[14] = query[2]
                    print("".join(Wall))
                    if query == answer:
